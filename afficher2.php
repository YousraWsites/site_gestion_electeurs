...
if (mysqli_num_rows($result1) > 0) {
   ...
   $_SESSION['numbv']= $_POST['numero_bv4'];
   $_SESSION['ecole']= $_POST['ecole4'];
   $_SESSION['adresse1']= $_POST['adresse4'];
   echo "<table>";
   ...
   echo "</table>";
    ...
    echo "<form action='soumettre.php' method='post'>";
    echo "<input type='submit'  name='sou'  value='Soumettre définitivement' class='c'  > ";
    echo "</form>";
